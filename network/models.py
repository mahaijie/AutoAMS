...
class Switch(models.Model):
    ...
    snmpcommunity = models.CharField('snmp团体名',default='',max_length=255)
...
class SwitchInterface(models.Model):
    name = models.CharField('接口名称',default='',max_length=255)
    cabinet = models.CharField('机柜',default='',max_length=255)
    position = models.CharField('机位',default='',max_length=255)
    user = models.CharField('操作员',default='',max_length=255)
    comment = models.TextField('备注',default='')
    uptime = models.DateTimeField('更新时间',auto_now=True,null=True)
    switch = models.ForeignKey(Switch,default='',verbose_name='所属交换机')
